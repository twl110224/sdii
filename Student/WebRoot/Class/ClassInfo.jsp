...
<form class="layui-form layui-form-pane" action="Javascript:void(0)">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
    	<input type="text" name="uname2" id="uname2" style="display:none" lay-verify="required" placeholder="请输入班级名"  autocomplete="off" class="layui-input">
      <input type="text" name="name" id="name" lay-verify="required" placeholder="请输入班级名" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <button class="layui-btn layui-btn-normal" id="xiugai" lay-filter="addUser">修改用户</button>
  </div>
</form>
...
<script type="text/javascript" src="<%=basePath %>/ClassInfo.js"></script>
</body>
</html>