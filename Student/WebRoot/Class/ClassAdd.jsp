...
<!-- <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="name" id="name" lay-verify="required" placeholder="请输入登录名" autocomplete="off" class="layui-input">
    </div>
  </div>
 <!--  <div class="layui-form-item">
...
<!--   <div class="layui-form-item">
 ...
 <!--  <div class="layui-form-item">
    <label class="layui-form-label">班级名</label>
    <div class="layui-input-inline">
      <input type="text" name="name" id="password" lay-verify="required" placeholder="请输入登陆密码" autocomplete="off" class="layui-input">
    </div> -->
...
<!--  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <select name="raid" id="raid" lay-filter="raid">
...
<!--   <div class="layui-form-item">
    <label class="layui-form-label">职称编号</label>
    <div class="layui-input-inline">
      <input type="text" name="raid" id="raid" lay-verify="required" placeholder="职称编号(1~3)" autocomplete="off" class="layui-input">
    </div>
  </div> -->
  
  <div class="layui-form-item">
    <button class="layui-btn layui-btn-normal" id="tijiao" lay-filter="addUser">新增用户</button>
  </div>
</form>
<script type="text/javascript" src="<%=basePath %>/layui/layui.js"></script>
<script type="text/javascript" src="/Student/ClassAdd.js"></script>
</body>
</html>