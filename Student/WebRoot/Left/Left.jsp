...
<link rel="stylesheet" href="/Student/layui/css/layui.css">
</head>
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
					...
					<c:forEach var="g" items="${list}">
						<li class="layui-nav-item layui-nav-itemed"><c:if
								...
								<a href="javascript:void(0)"
									onclick="Btn('${g.id}','${g.mbtn}')">${g.mname}</a>
								<%-- <ul>
	   ...
	   ${b.btn}
		...
		<script src="/Student/layui/layui.js"></script>

		<script type="text/javascript"
			src="<%=basePath%>/lib/jquery-3.4.1/jquery-3.4.1.min.js"></script>
		<script type="text/javascript" src="<%=basePath%>/Empl.js"></script>
		<script>
		...
		<script src="/Student/admin/js/lay-module/layui_ext/dtree/dtree.js"></script>
</body>
<!-- 分配权限 -->
