layui.use(['layer','table','treeTable'], function () {
        ...
        var tableIns = treeTable.render({
            ...
            cols : [[
                ...
                {field: 'mfatherid', title: '父级id',  align:'center'},
                {field: 'mfunction', title: '事件名称',  align:'center'},
                {field: 'type', title: '类型', align:'center'},
                {field: 'mbtn', title: '触发按钮',  align:'center'}         
            ]]
        });
		//监听工具栏
		    ...
		    switch(obj.event){
		      ...
		      case 'addMenu':	//新增权限
		    	  layer.open({
		        		title : "添加权限",
		        		type : 2,
		        		content : "/Student/Menu/menuAdd.jsp",
		        		area:['600px','600px'],
		    	  })
		      break;
